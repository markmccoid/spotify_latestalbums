...
const Playlists = () => {
  ...
  const [sortedData, setSortedData] = useState<SpotifyApi.PlaylistObjectSimplified[]>([]);
  ...
  return (
    <div className="border-r border-gray-600 ">
      <h1 className="bg-btn_bg py-2 text-center text-xl text-orange-500">Playlists</h1>
